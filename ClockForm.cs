...
namespace BRClock2
{
    public partial class ClockForm : Form
    {
        ...
        private void UpdateClock(object? sender, EventArgs e)
        {
            ...
            try
            {
                this.BackColor = ClockBackgroundColor;
            }
            catch (Exception)
            {
                this.BackColor = Color.White; // Fallback to white if there's an error
            }
        }
        ...
        // We have to break Fonts and Colors down when saving and loading.
